...
public class OperEx6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ch1 == num3\n" + (ch1 == num3)); // char하고 int 비교 : 자동형변환 일어남
        System.out.println("ch1 <= ch2\n" + (ch1 <= ch2));

        // float , double
        float f1 = 0.1f; // 0.100000000149011612
        double d1 = 0.1; // 0.100000000000000000
        ...
        // 대문자로 시작하면 자바에선 객체의 의미가 있음(객체 상태일 때 할 수 있는 것이 많음)
